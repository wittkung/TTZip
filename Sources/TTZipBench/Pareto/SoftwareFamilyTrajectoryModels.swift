...
public enum SoftwareFamily: String, Codable, CaseIterable, Identifiable, Sendable {
    ...
    public var brandColorHex: String {
        ...
        case .zstd:          return "#6366F1"
        case .lz4:           return "#06B6D4"
        case .xz:            return "#8B5CF6"
        case .brotli:        return "#EC4899"
        case .sevenZip:      return "#D97706"
        case .pigz:          return "#059669"
        case .minizipNg:     return "#84CC16"
        case .libdeflate:    return "#7C3AED"
        case .zopfli:        return "#EA4335"
        case .advzip:        return "#B45309"
        case .appleNative:   return "#DC2626"
        case .keka:          return "#0D9488"
        case .ouch:          return "#E11D48"
        case .bandizip:      return "#0284C7"
