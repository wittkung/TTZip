...
/* Appends an RFC 1951 empty non-compressed block (BFINAL=0, BTYPE=00, 0x00 0x00 0xFF 0xFF) for stream alignment */
void ZopfliAddSyncFlushBlock(unsigned char* bp, unsigned char** out, size_t* outsize);
