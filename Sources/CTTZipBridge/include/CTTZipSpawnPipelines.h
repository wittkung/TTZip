...
/**
 * @file CTTZipSpawnPipelines.h
 * @brief High-speed posix_spawn pipeline helpers.
 */

#ifndef CTTZipSpawnPipelines_h
#define CTTZipSpawnPipelines_h
