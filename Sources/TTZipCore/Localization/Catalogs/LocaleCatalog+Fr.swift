...
public enum LocaleCatalogFr {
    public static let strings: [String: String] = [
        ...
        "archive.corrupt_data": "Données d'archive corrompues",
        "archive.unsupported_format": "Format non pris en charge",
        "archive.format": "Format",
        "archive.compression_level": "Niveau de compression",
        "archive.split_volume": "Volume fractionné",
        ...
        "cli.error_invalid_format": "Format invalide: %@",
        "cli.dry_run_prefix": "[SIMULATION] Exécuterait: %@",
        "cli.bench_running": "Exécution du benchmark pour le format %@ (Passe %d/%d)...",
        "cli.test_summary": "Bilan des tests: %d réussis, %d échoués en %.2fs",
        ...
        "benchmark.peak_throughput": "Débit maximal",
        "benchmark.speedup": "Accélération",
        
        "error.file_not_found": "Le fichier ou le répertoire spécifié n'existe pas.",
        "error.permission_denied": "Permission refusée.",
        "error.disk_full": "Disque plein.",
        "error.zip_slip_detected": "Attaque de traversée de chemin Zip Slip détectée et bloquée.",
        "error.corrupted_header": "Vérification Magic d'en-tête échouée ou corrompue.",
        "error.crc_mismatch": "Erreur de somme de contrôle CRC32.",
        "error.out_of_memory": "Mémoire insuffisante.",
        ...
        "settings.license_status": "Statut de licence",
