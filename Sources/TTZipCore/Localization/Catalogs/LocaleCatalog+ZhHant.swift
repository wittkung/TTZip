...
public enum LocaleCatalogZhHant {
    public static let strings: [String: String] = [
        ...
        "archive.compress_success": "封存檔打包成功",
        "archive.extract_success": "封存檔解壓縮成功",
        ...
        "cli.test_summary": "測試彙總: %d 項通過, %d 項失敗 (耗时 %.2fs)",
        ...
        "error.permission_denied": "存取路徑權限遭拒。",
