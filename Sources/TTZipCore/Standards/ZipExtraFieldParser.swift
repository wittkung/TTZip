//
//  ZipExtraFieldParser.swift
//  TTZipCore
//
//  Zero-allocation Tag-Length-Value (TLV) parser for standard PKWARE & Info-ZIP Extra Fields.
//  Implements RFC/APPNOTE standards for timestamps, unicode paths, POSIX permissions, Zip64, and WinZip AES.
//
